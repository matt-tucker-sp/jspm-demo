...
$__System.register('7', ['2', '6'], function (_export) {
    var _classCallCheck, _createClass, DoSomethingCtrl;
    ...
    return {
        ...
        execute: function () {
            ...
            DoSomethingCtrl = (function () {
                function DoSomethingCtrl(commonService) {
                    'ngInject';

                    _classCallCheck(this, DoSomethingCtrl);

                    this.commonService = commonService;
                }

                _createClass(DoSomethingCtrl, [{
                    key: 'getThatThing',
                ...
                return DoSomethingCtrl;
            })();

            _export('default', DoSomethingCtrl);
        }
    };
});
...
$__System.registerDynamic("9", ["a", "8"], true, function(req, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var angular = req('a');
  var CommonModule = angular.module('CommonModule', []).service('commonService', req('8'));
...
$__System.register('b', ['7', '9', 'a'], function (_export) {
            ...
            var doSomethingCtrl, commonModule, angular;
            return {
                        setters: [function (_2) {
                                    doSomethingCtrl = _2['default'];
                        }, function (_) {
                                    commonModule = _['default'];
                        }, function (_a) {
                                    angular = _a['default'];
                        }],
                        execute: function () {
                                    _export('default', angular.module('doSomething', [commonModule.name]).controller('DoSomethingCtrl', doSomethingCtrl));
                        }
            };
});
$__System.register('c', ['a', 'b'], function (_export) {
   'use strict';

   var angular, doSomething;
   return {
      setters: [function (_a) {
         angular = _a['default'];
      }, function (_b) {
         doSomething = _b['default'];
      }],
      execute: function () {
         _export('default', angular.module('main', [doSomething.name]));
      }
   };
});
      ...
      function $CompileProvider($provide, $$sanitizeUriProvider) {
        ...
        this.$get = ['$injector', '$interpolate', '$exceptionHandler', '$templateRequest', '$parse', '$controller', '$rootScope', '$document', '$sce', '$animate', '$$sanitizeUri', function($injector, $interpolate, $exceptionHandler, $templateRequest, $parse, $controller, $rootScope, $document, $sce, $animate, $$sanitizeUri) {
          ...
          function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn, jqCollection, originalReplaceDirective, preLinkFns, postLinkFns, previousCompileContext) {
            ...
            function getControllers(directiveName, req, $element, elementControllers) {
              var value,
              ...
              var match;
              if (isString(req)) {
                match = req.match(REQUIRE_PREFIX_REGEXP);
                req = req.substring(match[0].length);
                if (match[3]) {
                  if (match[1])
                    match[3] = null;
                  else
                ...
                if (elementControllers && retrievalMethod === 'data') {
                  if (value = elementControllers[req]) {
                    value = value.instance;
                  }
                }
                value = value || $searchElement[retrievalMethod]('$' + req + 'Controller');
                if (!value && !optional) {
                  throw $compileMinErr('ctreq', "Controller '{0}', required by directive '{1}', can't be found!", req, directiveName);
                }
                return value || null;
              } else if (isArray(req)) {
                value = [];
                forEach(req, function(req) {
                  value.push(getControllers(directiveName, req, $element, elementControllers));
                });
              }
              return value;
            }
...
$__System.registerDynamic("a", ["12"], true, function(req, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
